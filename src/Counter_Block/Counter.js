	...
	edit: function(props) {
			...
			const styling = useMemo(
				...
				[
					...
					props.attributes.widgetSize ,
					props.attributes.counterShapeClass,
					props.attributes.haloColor,
				]
			);
			...
			const titleStyling = useMemo(
				...
				[
					props.attributes.titleFontColor,
					props.attributes.titleFontFamily ,
					props.attributes.titleFontSize,
				]
			);
			...
			const numberStyling = useMemo(
				...
				[
					props.attributes.numberFontColor,
					props.attributes.numberFontFamily ,
					props.attributes.numberFontSize,
				]
			);
			...
			var colorControls = (
				<ColorPopup 
						...
						value={{ value:props.attributes.backgroundColor}}
			...
			if(props.attributes.counterShapeClass==='k2-cw-halo'){
				...
				<div>
						...
						<ColorPopup 
								label={"Halo Color"}
								value={{ value:props.attributes.haloColor}}
								onChange = { ( value ) => {props.setAttributes( {haloColor:value} ); console.log(props.attributes.haloColor)} }
								PropertyName={"backgroundColor"}
						/>
			...
			return ([
				<InspectorControls>
					...
					<PanelBody title={"Counter Layout"}>
						<SelectControl 
							...
							value={props.attributes.counterLayout}
					...
					<PanelBody title={"Styling and color"}>
						...
						<ColorPopup 
								label={"Number Color"}
								value={{ value:props.attributes.numberFontColor}}
						...
						<ColorPopup 
								label={"Title Color"}
								value={{ value:props.attributes.titleFontColor}}
				...
				<div className="k2-cw-parent">
					{
						props.attributes.counterLayout == 'advance' ?
						<div className="k2-cw-container" style={{width:'190px'}}>
							<div className="k2-cw-content k2-contentadvance-flex" style={contentStyling}>
								<div className={"k2-cw-advance-background"+"  "+props.attributes.counterShapeClass} style={advanceStytling}></div>
							...
							<p className="k2-cw-title" style={adtitleStyling }> {props.attributes.title} </p>	
						</div>
						:
