	...
	edit: function(props) {
			...
			function onChangeBackgroundColor(value) {
				if(props.attributes.TimerLayout == 'Classic')
					props.setAttributes(
						{
							TimerValueBackgroundColor: value,
						}
					)
				else{
					props.setAttributes(
				...
				<InspectorControls>
					...
					<PanelBody title={"Background"}>
						...
						/>
						{
							...
							<ColorPopup 
								label={"Timer color"}
								value={{ value: props.attributes.TimerValueBackgroundColor}}
							...
							<ColorPopup 
								label={"Timer color"}
								value={{ value: props.attributes.BlockBackgroundColor}}
								onChange = {onChangeBackgroundColor}
								PropertyName={"backgroundColor"}
						/>
					...
					<PanelBody title={"Numbers Styling"}>
						<ColorPopup 
								label={"Numbers color"}
								value={{ value:props.attributes.TimerValueColor}}
					...
					<PanelBody title={"Text Styling"}>
						...
						<ColorPopup 
								label={"Text color"}
								value={{ value:props.attributes.TimerTextColor}}
